...
module.exports = function StepDefinition(regexp, bodyFn, bodyLocation) {
 this.bodyLocation = bodyLocation;
  ...
  this.createTestStep = function (pickleStep, path) {
    ...
    if (match) {
      ...
      var gherkinLocations = pickleStep.locations.map(function (location) {
        return {
          path: path,
          line: location.line,
      ...
      return new TestStep(gherkinLocations, matchedArguments, bodyFn, bodyLocation);
    } else {
      return null;
    }
  }
